...
The model is controlled by the CNN class (stored in _CNN.cpp_ ). CNN class methods:
...
The CNN folder contains examples of equations (example.jpg and example_1-4.jpg) that we can solve.

## 8. Report 

The report, along with a literature review and a more detailed description of the project, is available in the report.pdf file.

## 9. Roles in the team

- Ayauly Chayakova and Maram Marsaoui - Implementation of the NN 
- Abeer Obeid - Study of various approaches to solving the problem, preparation of the dataset
